...
import { useAudioPlayback } from "@/components/AudioPlayer";
...
function ConversationContent() {
  ...
  const { unlockAudio, playBuffer } = useAudioPlayback();
        ...
        try {
          ...
          if (contentType?.includes("audio/mpeg")) {
            ...
            try {
              ...
              console.error("[Conversation] Browser TTS error for greeting:", e);
            }
            setSpeaking(false);
          }
        } catch (error) {
          ...
          try {
            ...
            console.error("[Conversation] Browser TTS fallback error:", e);
          }
          setSpeaking(false);
        }
      }
  ...
  }, [setMicrophoneError, unlockAudio]);
  ...
  }, [addMessage, setProcessing, setSpeaking, getApiMessages, playBuffer]);
