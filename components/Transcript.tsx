    ...
    return (
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="text-center max-w-xs">
          <div className="w-14 h-14 mx-auto mb-2 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center">
          ...
          <p className="text-slate-900 dark:text-white text-lg font-medium mb-1">
            Bienvenue!
          </p>
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            Hold the button below to speak French
          </p>
        </div>
      </div>
    );
